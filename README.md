...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-mv-pr5g.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-mv-pr5g.containers.anotherwebservice.com/
...
```
git clone git@github.com:samgo94/demo.git
cd container-mv-pr5g
```
...
```
docker attach container-mv-pr5g
```
